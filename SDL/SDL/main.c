 ...
 * Hinweis: Detailliertes Verst‰ndnis der verschiedenen            *
 *          SDL-Funktionen ist f¸r Programmiercamp/Klausur nicht   *
 *          erforderlich. Es gen¸gt, die bereit gestellten         *
...
int main(int argc, char *argv[])
{
    ...
    width=1200; height=700;    // size of window
